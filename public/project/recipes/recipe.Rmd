...
path_to_recipe <<- ifelse(Sys.info()['nodename'] =="DESKTOP-RFKFT3H", "D:/abire/Documents/recipes/", ifelse(Sys.info()['nodename'] == "adamubuntu", "/home/adam/adambirenbaum.com/public/project/recipes/","/var/www/adambirenbaum.com/public/project/recipes/")  )
...
new_title <- gsub(" ","_",recipe_database$Name,fixed = T)

img_files <- list.files(paste0(path_to_recipe,"img/"))
img <- img_files[grepl(new_title,x = img_files,fixed = T)]
